                    ...
                    <section class="content-header z-depth-1">
                        ...
                        <div class="header-title">
                            ...
                            <ul class="link hidden-xs">
                                ...
                                <li><a href="addproducts.php">Add customer</a></li>
                            </ul>
                        </div>
                    </section>
                            <!-- bootstrap table -->
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <form action="updatecustomers.php?id=<?php echo $_GET['id']; ?>" name="myform" id="myForm" method="POST">
                                          <div class="form-row">
                                            <div class="form-group col-md-6">
                                              ...
                                              $query1 = "Select * FROM customer WHERE customerID = $id ";

                                              $result1 = mysqli_query($connection, $query1);
                                                while ($row1 = mysqli_fetch_assoc($result1))
                                                      { ?>
                                              <label for="customer_name">Customer Name</label>
                                              <input type="text" class="form-control" id="customerName" name="customerName" placeholder="Customer Name" value="<?php echo $row1["customerName"];?>">
                                            </div>
                                            <div class="form-group col-md-6">
                                              <label for="customer_email">Customer Email</label>
                                              <input type="text" class="form-control" id="customerEmail" name="customerEmail" placeholder="Customer Email" value="<?php echo $row1["customerEmail"];?>">
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label for="customer_order">Customer Order</label>
                                            <input type="text" class="form-control" id="customerOrder" name="customerOrder" placeholder="Customer Order" value="<?php echo $row1["customerOrder"];?>">
                                          </div>
