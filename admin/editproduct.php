                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <div class="table-responsive">
                                          <!-- Form to add products starts here  -->
                                        <form action="updateinvt.php?id=<?php echo $_GET['id']; ?>" name="myform" id="myForm" method="POST">
                                          <div class="form-row">
                                            <div class="form-group col-md-6">
                                              ...
                                              $query1 = "Select * FROM inventory WHERE itemID = $id ";

                                              $result1 = mysqli_query($connection, $query1);
                                                while ($row1 = mysqli_fetch_assoc($result1))
                                                      { ?>
                                              <label for="inputEmail4">Product Name</label>
                                              <input type="text" class="form-control" id="product" name="product" value="<?php echo $row1["itemName"];?>" placeholder="Product Name">
                                            </div>
                                            <div class="form-group col-md-6">
                                              <label for="inputPassword4">Quantity</label>
                                              <input type="text" class="form-control" id="quantity" name="quantity" value="<?php echo $row1["itemQuantity"];?>" placeholder="0-1000">
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label for="inputAddress">Price</label>
                                            <input type="text" class="form-control" id="price" name="price" value="<?php echo $row1["itemPrice"];?>" placeholder="RM">
                                          </div>
