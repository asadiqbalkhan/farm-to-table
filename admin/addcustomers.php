                    ...
                    <section class="content-header z-depth-1">
                        ...
                        <div class="header-title">
                            ...
                            <ul class="link hidden-xs">
                                ...
                                <li><a href="addproducts.php">Add customers</a></li>
                            </ul>
                        </div>
                    </section>
                            <!-- bootstrap table -->
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <form action="add_customer.php" name="myform" id="myForm" method="POST">
                                          <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                              ...
                                              <input type="text" class="form-control" id="customerOrder" name="customerOrder" placeholder="Enter Customer Order">
                                            </div>
                                          </div>
                                          <br>

                                          <input type="button" onclick="myFunction()" class="btn btn-primary" value="Add">
                                        </form>
