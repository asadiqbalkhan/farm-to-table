...
<?php include_once 'include/navigation_loggedin_admin.php'; ?>
<!-- ============================================ -->
<!--       BODY OF THE 'loginadmin' PAGE              -->
<!-- ============================================ -->
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              <!-- If admin logs in display this page -->
              <form role="form" action="loginadmin.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="pasword" class="form-control" id="password" placeholder="Enter password">
                </div>
                <div class="checkbox">
